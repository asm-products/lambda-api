...
describe Game, type: :model do
  describe 'relationships' do
    ...
    it { is_expected.to belong_to(:player_1).class_name('User')
         .inverse_of(:games_as_player_1) }

    it { is_expected.to belong_to(:player_2).class_name('User')
         .inverse_of(:games_as_player_2) }

    it { is_expected.to belong_to(:winner).inverse_of(:games_won)
         .class_name('User') }
